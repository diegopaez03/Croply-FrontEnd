...
export function MensajePendienteFinca() {
  const { logoutState } = useAuth();

  return (
    <div className="max-w-md w-full mx-auto bg-white border border-border shadow-sm rounded-xl p-8 text-center space-y-6">
